...
if __name__ == '__main__':
    ...
    # argparser.add_argument('--config_file', default='/Users/tianhongzxy/Downloads/BiSentESIM/BiSentESIM/snli/default.cfg')
    ...
    vocab = creatVocab('/content/drive/My Drive/snli/data/snli.train.txt', config.min_occur_count)
    ...
    data = read_corpus('/content/drive/My Drive/snli/data/snli.train.txt')
    dev_data = None#read_corpus(config.dev_file)
    test_data = None#read_corpus(config.test_file)
